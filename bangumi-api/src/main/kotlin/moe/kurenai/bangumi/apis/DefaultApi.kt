...
open class DefaultApi(
    ...
    open suspend fun getUserCharacterCollection(
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/v0/users/{username}/collections/-/characters/{character_id}".replace("{" + "username" + "}", "$username")
    ...
    open suspend fun getUserPersonCollection(
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/v0/users/{username}/collections/-/persons/{person_id}".replace("{" + "username" + "}", "$username")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun searchSubjectByKeywords(
        keywords: kotlin.String,
        type: LegacySubjectType?,
        responseGroup: kotlin.String?,
        start: kotlin.Int?,
        maxResults: kotlin.Int?
    ): HttpResponse<SearchSubjectByKeywords200Response> {
